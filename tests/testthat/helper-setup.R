...
invisible(ref.files <- list(
  q3.normalized.counts     = file.path(ref.dir, "ref_q3normalized_counts.csv"),
  standr.logcounts         = file.path(ref.dir, "ref_standr_logcounts.csv"),
  de.glom_v_tubule.default = file.path(ref.dir, "ref_DKD_Glomerulus_vs_Tubule_default_de.results.csv"),
  de.glom_v_tubule.standr  = file.path(ref.dir, "ref_DKD_Glomerulus_vs_Tubule_standr_de.results.csv")
))
...
expect_table_equal <- function(current, ref, id.col, tolerance = 1e-6) {
