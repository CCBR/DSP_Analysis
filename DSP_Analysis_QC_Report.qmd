...
#### Export Pre-Normalization Object

```{r Export Filtered Object, warning=FALSE, message=FALSE}

# Save the filtered object
saveRDS(object.gene.filtered, file = paste0(params$results.folder, 
                                         params$run.folder, 
                                         params$dataset.name, 
                                         "_filtered_object.RDS"))
