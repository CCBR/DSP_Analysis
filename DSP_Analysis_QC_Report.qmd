...
if(export.norm.object == TRUE){
  ...
  save(object, file = paste0(params$results.folder, 
                             params$dataset.name, "_q3normalized_object_skin.RDA"))
  
  write.csv(q3.counts, file = paste0(params$results.folder, 
                                  params$dataset.name, "_q3normalized_counts_skin.csv"), 
            row.names = FALSE)
  
  # Save the quantile normalized.counts
  write.csv(quant.counts, file = paste0(params$results.folder, 
                                  params$dataset.name, "_quantnormalized_counts_skin.csv"), 
            row.names = FALSE)
